// program to creates and displays an undirected graph using an adjacency list and then performs a recursive Depth-First Search (DFS) traversal starting from a user-specified vertex.
import java.util.*;
 class p9 {
